               ...
               <ul class="dropdown-menu multi-level">
                  ...
                  <li class="dropdown-submenu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Add Back Up Roll Entry</a>
                      <ul class="dropdown-menu">
                        <li class="dropdown-submenu">
                          <li><a href="/machineSection/addMachineBackUpRollEntry?type=1">Back Up Roll 1</a></li>
                          <li><a href="/machineSection/addMachineBackUpRollEntry?type=2">Back Up Roll 2</a></li>
                        </li>
                      </ul>
                  </li>
               </ul>
