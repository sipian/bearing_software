...
router.post('/checkPassword', function (req, res, next) {
    ...
    var correct_password = 'b7b64a56e78190dc159e8cd5bb8fb5acb98f732075e2b98ec7b715e30062dcd7',
        ...
        res.redirect('/updateEntry/home');
            ...
            db.workroll.update({ roll: req.query.name }, { $pull: { field: {
                ...
                comment : req.query.comment
                  ...
                  if(err || numRemoved == 0)
                      res.redirect(`/updateEntry/deleteExistingEntry?type=roll&name=${req.query.name}&message=ERROR!%20%3C/strong%3E${((err)?err.message:"Entry%20Not%20Found")}`);
                  else
                      res.redirect(`/updateEntry/deleteExistingEntry?type=roll&name=${req.query.name}&message=SUCCESS!%20%3C/strong%3EDeleted%20Work%20Roll%20Entry%20Successfully`);
              });
          }
      }
});
